...
export const ALLOWED_TRANSITIONS: Record<ProvisionState, ProvisionState[]> = {
  ...
  SUPABASE_CREATING: ['SUPABASE_READY', 'FAILED'],
  SUPABASE_READY: ['GITHUB_CREATING', 'FAILED'],
  GITHUB_CREATING: ['GITHUB_READY', 'FAILED'],
  GITHUB_READY: ['VERCEL_CREATING', 'FAILED'],
  VERCEL_CREATING: ['VERCEL_DEPLOYING', 'FAILED'],
  VERCEL_DEPLOYING: ['ELEVENLABS_CREATING', 'FAILED'],
  ELEVENLABS_CREATING: ['WEBHOOK_REGISTERING', 'FAILED'],
  WEBHOOK_REGISTERING: ['COMPLETE', 'FAILED'],
  COMPLETE: [],
  FAILED: ['INIT'],
};
